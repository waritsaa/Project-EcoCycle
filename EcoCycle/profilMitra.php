...
mysqli_fetch_assoc(
mysqli_query( $conn,
"SELECT COALESCE(SUM(berat_kg),0) total
FROM marketplace
WHERE status='tersedia'"
))['total'];
...
mysqli_fetch_assoc(
mysqli_query( $conn,
"SELECT COALESCE(SUM(harga),0) total
FROM marketplace
WHERE status='tersedia'"
))['total'];
?>
...
<ul class="nav-menu" id="navMenu">
    <li><a href="pengepul_dashboard.php"> 🏠 Home</a></li>
    <li><a href="profilMitra.php" class="active-link">👤 Profil</a></li>
...
<section class="dashboard-container">
    <div class="profile-modern-card">
        <div class="profile-header-modern">
            ...
            <span class="role-badge"> Mitra Daur Ulang</span>
            <p class="joined-date">
                Bergabung :
...
<div class="content-card">
    <h2>📊 Statistik Mitra Daur Ulang</h2>
    <div class="status-item">
        <div class="info"><span>Total Listing</span></div>
        <span class="status status-selesai"><?php echo $totalListing; ?></span>
    </div>

    <div class="status-item">
        <div class="info"><span>Listing Tersedia</span></div>
        <span class="status status-diproses"><?php echo $totalTersedia; ?></span>
    </div>

    <div class="status-item">
        <div class="info"><span>Total Berat Sampah</span></div>
        <span class="status status-selesai"><?php echo round($totalBerat,1); ?> Kg</span>
    </div>

    <div class="status-item">
        <div class="info"><span>Estimasi Nilai Sampah</span></div>
